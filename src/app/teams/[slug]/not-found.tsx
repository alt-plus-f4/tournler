			...
			<Card className='w-full max-w-xl border-gray-800 bg-gradient-to-br from-zinc-950 to-black'>
				<CardContent className='p-8 text-center space-y-6'>
					...
					<div className='space-y-2'>
						<h1 className='text-3xl font-extrabold text-white'>Team not found</h1>
						<p className='text-sm text-zinc-400'>This team may have been deleted or the link is invalid.</p>
					</div>
